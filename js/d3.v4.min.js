...
!function(t, n) {
    ...
    function u(t, n) {
        ...
        if (null == n)
            for (; ++c < i;)
                isNaN(e = o(t[c])) || (r = e - u, u += r / ++s, a += r * (e - u));
        else
            for (; ++c < i;)
                isNaN(e = o(n(t[c], c, t))) || (r = e - u, u += r / ++s, a += r * (e - u));
        if (s > 1)
            return a / (s - 1)
    }
    function a(t, n) {
    ...
    function v() {
        function t(t) {
            ...
            var d,
                v = new Array(p + 1);
            for (i = 0; i <= p; ++i)
                d = v[i] = [], d.x0 = i > 0 ? l[i - 1] : s, d.x1 = i < p ? l[i] : f;
            for (i = 0; i < u; ++i)
                o = a[i], s <= o && o <= f && v[Sd(l, o, 0, p)].push(t[i]);
            return v
        }
        var n = f,
            e = c,
    ...
    function b(t, e) {
        ...
        if (null == e)
            for (; ++a < u;)
                isNaN(r = o(t[a])) || i.push(r);
        else
            for (; ++a < u;)
                isNaN(r = o(e(t[a], a, t))) || i.push(r);
        return _(i.sort(n), .5)
    }
    function w(t) {
    ...
    function L() {
        function t(n, i, u, a) {
            ...
            for (var c, s, f, l = -1, h = n.length, p = o[i++], d = q(), v = u(); ++l < h;)
    ...
    function mt(t) {
        for (var n = t.length, e = [0, 1], r = 2, i = 2; i < n; ++i) {
            for (; r > 1 && yt(t[e[r - 2]], t[e[r - 1]], t[i]) <= 0;)
                --r;
            e[r++] = i
        }
        return e.slice(0, r)
    ...
    function sn() {
        function t() {
            ...
            if (c || (c = t = Tt()), l < f && (s = l, l = f, f = s), l > _v)
                if (d > mv - _v)
                    c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > _v && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v));
                else {
                    var _,
                        y,
                        g = h,
    ...
    function Tn() {
        function t() {
            var t;
            if (r || (r = t = Tt()), n.apply(this, arguments).draw(r, +e.apply(this, arguments)), t)
    ...
    function Pe(t) {
        if (t instanceof Le)
            return new Le(t.l, t.a, t.b, t.opacity);
        if (t instanceof Ye) {
            var n = t.h * o_;
    ...
    function Fe(t) {
        if (t instanceof Ye)
            return new Ye(t.h, t.c, t.l, t.opacity);
    ...
    function ar(t, n) {
        var e,
            r,
            i,
            o = C_.lastIndex = z_.lastIndex = 0,
            u = -1,
            a = [],
            c = [];
        for (t += "", n += ""; (e = C_.exec(t)) && (r = z_.exec(n));)
    ...
    function yr(t, n) {
        var e,
            ...
            h = f * f + l * l;
        if (h < F_)
            r = Math.log(s / u) / U_, e = function(t) {
    ...
    function Br() {
        Or(), ++ly;
        for (var t, n = W_; n;)
            (t = _y - n._time) >= 0 && n._call.call(null, t), n = n._next;
        --ly
    }
    function jr(t) {
    ...
    function Xr() {
        for (var t, n, e = W_, r = 1 / 0; e;)
            e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : W_ = n);
        $_ = t, Vr(r)
    }
    function Vr(t) {
        if (!ly) {
        ...
        function n(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date((+e))); ++a < s;)
                    37 === t.charCodeAt(a) && (u.push(t.slice(c, a)), null != (i = zg[r = t.charAt(++a)]) ? r = t.charAt(++a) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), u.push(r), c = a + 1);
        ...
        function r(t, n, e, r) {
            for (var i, o, u = 0, a = n.length, c = e.length; u < a;) {
                ...
                if (i = n.charCodeAt(u++), 37 === i) {
                    if (i = n.charAt(u++), o = B[i in zg ? n.charAt(u++) : i], !o || (r = o(t, e, r)) < 0)
                        return -1
    ...
    function Su(t, n, e, r, i, o, u) {
        var a,
            ...
            p = new Array(l);
        for (a = 0; a < l; ++a)
            (c = n[a]) && (p[a] = s = ym + u.call(c, c.__data__, a, n), s in f ? i[a] = c : f[s] = c);
        for (a = 0; a < h; ++a)
            s = ym + u.call(t, o[a], a, o), (c = f[s]) ? (r[a] = c, c.__data__ = o[a], f[s] = null) : e[a] = new Tu(t, o[a]);
        for (a = 0; a < l; ++a)
            (c = n[a]) && f[p[a]] === c && (i[a] = c)
    }
    function Au(t, n) {
    ...
    function oa(t, n) {
        for (var e = ra(t), r = -1, i = n.length; ++r < i;)
            e.add(n[r])
    }
    function ua(t, n) {
        for (var e = ra(t), r = -1, i = n.length; ++r < i;)
    ...
    function Ia(t, n) {
        ...
        if (!e || !(e = e[n]) || e.state > bm)
            throw new Error("too late");
        return e
    }
    function Ya(t, n) {
        var e = t.__transition;
        if (!e || !(e = e[n]) || e.state > Mm)
            throw new Error("too late");
        return e
    }
    function Ba(t, n) {
    ...
    function ja(t, n, e) {
        ...
        function i(r) {
            var i,
                ...
                f;
            for (i in a)
                f = a[i], f.name === e.name && (f.state === Tm ? (f.state = Nm, f.timer.stop(), f.on.call("interrupt", t, t.__data__, f.index, f.group), delete a[i]) : +i < n && (f.state = Nm, f.timer.stop(), delete a[i]));
            if (Wr(function() {
                e.state === Tm && (e.timer.restart(o, e.delay, e.time), o(r))
            }), e.state = Mm, e.on.call("start", t, t.__data__, e.index, e.group), e.state === Mm) {
                for (e.state = Tm, u = new Array(s = e.tween.length), i = 0, c = -1; i < s; ++i)
                    (f = e.tween[i].value.call(t, t.__data__, e.index, e.group)) && (u[++c] = f);
                u.length = c + 1
            }
        }
        function o(r) {
            for (var i = r < e.duration ? e.ease.call(null, r / e.duration) : (e.state = km, 1), o = -1, c = u.length; ++o < c;)
                u[o].call(null, i);
            if (e.state === km) {
                e.state = Nm, e.timer.stop(), e.on.call("end", t, t.__data__, e.index, e.group);
                for (o in a)
                    if (+o !== n)
                        return void delete a[n];
    ...
    function Ha(t, n) {
        ...
        if (o) {
            n = null == n ? null : n + "";
            for (i in o)
                (e = o[i]).name === n ? (r = e.state === Tm, e.state = Nm, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : u = !1;
    ...
    function wc(t) {
        ...
        for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
            for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)
                (a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Fa(l[h], n, e, h, l, Ba(a, e)));
    ...
    function Mc(t) {
        ...
        for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
            for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
                if (c = s[l]) {
                    for (var h, p = t.call(c, c.__data__, l, s), d = Ba(c, e), v = 0, _ = p.length; v < _; ++v)
    ...
    function Yc(t, n) {
        ...
        if (i) {
            n = null == n ? null : n + "";
            for (r in i)
                if ((e = i[r]).state > wm && e.name === n)
                    return new Uc([[t]], zm, n, (+r))
        }
        return null
    }
    function Bc(t) {
        ...
        for (null == n && (n = ms); e = s.pop();)
            if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length))
                for (e.children = new Array(u), o = u - 1; o >= 0; --o)
                    s.push(r = e.children[o] = new ws(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function Ss(t, n) {
        ...
        for (; u;)
            i = u._, r = u.next, e && Ns(e, i) ? o = u : (o ? (t.tail = o, o.next = null) : t.head = t.tail = null, n.push(i), e = Ss(t, n), n.pop(), t.head ? (u.next = t.head, t.head = u) : (u.next = null, t.head = t.tail = u), o = t.tail, o.next = r), u = r;
        return t.tail = o, e
    }
    function As(t) {
        return {
    ...
    function Rs(t) {
        ...
        for (a = 3; a < i; ++a) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, v += d = r._.r * r._.r, _ += d * r._.x, y += d * r._.y, h = qs(n._, o = _ / v, u = y / v); (r = r.next) !== e;)
    ...
    function Js() {
        function t(t) {
            var r,
                ...
                h = {};
            for (i = 0; i < f; ++i)
                r = t[i], a = l[i] = new ws(r), null != (c = n(r, i, t)) && (c += "") && (s = Om + (a.id = c), h[s] = s in h ? Im : a);
            for (i = 0; i < f; ++i)
            ...
            }).eachBefore(bs), o.parent = null, f > 0)
    ...
    function af() {
        ...
        function r(t, n, e) {
            if (n) {
                for (var r, i = t, u = t, a = n, c = i.parent.children[0], s = i.m, f = u.m, l = a.m, h = c.m; a = tf(a), i = Ks(i), a && i;)
                    c = Ks(c), u = tf(u), u.a = t, r = a.z + l - i.z - s + o(a._, i._), r > 0 && (nf(rf(a, t, e), t, r), s += r, f += r), l += a.m, s += i.m, h += c.m, f += u.m;
        ...
        function n() {
            ...
            for (var n, a, c, s, f, l, h, p = r.length, d = 0; d < u; ++d)
                for (a = jt(r, _f, yf).visitAfter(e), n = 0; n < p; ++n)
                    c = r[n], l = i[n], h = l * l, s = c.x + c.vx, f = c.y + c.vy, a.visit(t)
        }
        function e(t) {
            if (t.data)
        ...
        function e(n) {
            for (var e = 0, r = t.length; e < d; ++e)
                for (var i, o, c, s, l, h, p, v = 0; v < r; ++v)
                    i = t[v], o = i.source, c = i.target, s = c.x + c.vx - o.x - o.vx || vf(), l = c.y + c.vy - o.y - o.vy || vf(), h = Math.sqrt(s * s + l * l), h = (h - a[v]) / h * n * u[v], s *= h, l *= h, c.vx -= s * (p = f[v]), c.vy -= l * p, o.vx += s * (p = 1 - p), o.vy += l * p
        }
        function r() {
            if (c) {
                var n,
                    ...
                    h = t.length,
                    p = q(c, l);
                for (n = 0, s = new Array(r); n < r; ++n)
                    s[n] = 0;
                for (n = 0; n < h; ++n)
                    e = t[n], e.index = n, "object" != typeof e.source && (e.source = p.get(e.source)), "object" != typeof e.target && (e.target = p.get(e.target)), ++s[e.source.index], ++s[e.target.index];
    ...
    function Tf() {
        ...
        function r(t, n, e, r) {
            ...
            var i = t.x - o.x,
                ...
                p = i * i + c * c;
            if (h * h / l < p)
                return p < f && (0 === i && (i = vf(), p += i * i), 0 === c && (c = vf(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p), !0;
            if (!(t.length || p >= f)) {
        ...
        function o() {
            if (l.apply(this, arguments)) {
                var n,
                    ...
                    o = r.length;
                for (n = 0; n < o; ++n)
                    (e = c(r[n].identifier, i, Da, this, arguments)) && (Sf(), e("start"))
            }
        }
        function u() {
            var n,
    ...
    function Gf(t, n, e, r) {
        for (var i, o = Gm.length; o--;)
            Zf(i = Gm[o], t, n, e, r) && $f(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > Km || Math.abs(i[0][1] - i[1][1]) > Km) || delete Gm[o]
    }
    function Jf(t) {
        return $m[t.index] = {
            site: t,
    ...
    function el(t, n, e, r) {
        ...
        for (i = 0; i < _; ++i)
            if (o = $m[i]) {
                ...
                for (a = 0, s = c.length; a < s;)
                    p = tl(o, Gm[c[a]]), d = p[0], v = p[1], f = Kf(o, Gm[c[++a % s]]), l = f[0], h = f[1], (Math.abs(d - l) > Km || Math.abs(v - h) > Km) && (c.splice(a, 0, Gm.push(Vf(u, p, Math.abs(d - t) < Km && r - v > Km ? [t, Math.abs(l - t) < Km ? h : r] : Math.abs(v - r) < Km && e - d > Km ? [Math.abs(h - r) < Km ? l : e, r] : Math.abs(d - e) < Km && v - n > Km ? [e, Math.abs(l - e) < Km ? h : n] : Math.abs(v - n) < Km && d - t > Km ? [Math.abs(h - n) < Km ? l : t, n] : null)) - 1), ++s);
                s && (y = !1)
            }
        if (y) {
            var g,
            ...
            for (i = 0, y = null; i < _; ++i)
                (o = $m[i]) && (u = o.site, g = u[0] - t, m = u[1] - n, x = g * g + m * m, x < b && (b = x, y = o));
            if (y) {
                var w = [t, n],
                    M = [t, r],
                    T = [e, r],
        ...
        for (i = 0; i < _; ++i)
            (o = $m[i]) && (o.halfedges.length || delete $m[i])
    }
    function rl() {
    ...
    function sl(t) {
        var n = t.circle,
            ...
            a = [t];
        cl(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < Km && Math.abs(r - c.circle.cy) < Km;)
            o = c.P, a.unshift(c), cl(c), c = o;
        a.unshift(c), ol(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < Km && Math.abs(r - s.circle.cy) < Km;)
    ...
    function fl(t) {
        ...
        if (Wm.insert(n, c), n || e) {
            if (n === e)
                return ol(n), e = al(n.site), Wm.insert(c, e), c.edge = e.edge = Xf(n.site, c.site), il(n), void il(e);
            if (!e)
                return void (c.edge = Xf(n.site, c.site));
            ol(n), ol(e);
            var s = n.site,
                f = s[0],
                l = s[1],
    ...
    function vl(t, n) {
        ...
        for (Gm = [], $m = new Array(t.length), Wm = new If, Zm = new If;;)
            if (i = Vm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x))
                o[0] === e && o[1] === r || (fl(o), e = o[0], r = o[1]), o = t.pop();
            else {
                if (!i)
                    break;
                sl(i.arc)
    ...
    function Nl() {
        ...
        function h() {
            if (y.apply(this, arguments)) {
                var n,
                    ...
                    u = o.length;
                for (bl(), n = 0; n < u; ++n)
                    e = o[n], r = Da(this, o, e.identifier), r = [r, this.__zoom.invert(r), e.identifier], i.touch0 ? i.touch1 || (i.touch1 = r) : i.touch0 = r;
        ...
        function p() {
            ...
            for (wl(), v && (v = clearTimeout(v)), n = 0; n < l; ++n)
                o = f[n], u = Da(this, f, o.identifier), s.touch0 && s.touch0[2] === o.identifier ? s.touch0[0] = u : s.touch1 && s.touch1[2] === o.identifier && (s.touch1[0] = u);
        ...
        function u() {
            ...
            function u() {
                if (El(), t.event.touches) {
                    ...
                    Cf(t.event.view, b), B.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);
    ...
    function Zl() {
        function t() {
            var t,
                ...
                _ = i.apply(this, a) - yx,
                y = o.apply(this, a) - yx;
            if (u || (u = t = Tt()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === y || (u.quadraticCurveTo(0, 0, v * dx(_), v * vx(_)), u.arc(0, 0, v, _, y)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t)
    ...
    function Eh(t) {
        ...
        if (Ux ? Ux.reset() : Ux = Gl(), zx = Cx = -(Ax = Ex = 1 / 0), Dx = [], uh(t, kb), e = Dx.length) {
            for (Dx.sort(Sh), n = 1, r = Dx[0], o = [r]; n < e; ++n)
                i = Dx[n], Ah(r, i[0]) || Ah(r, i[1]) ? (Nh(r[0], i[1]) > Nh(r[0], r[1]) && (r[1] = i[1]), Nh(i[0], r[1]) > Nh(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n)
                i = o[n], (a = Nh(r[1], i[0])) > u && (u = a, Ax = i[0], Cx = r[1])
        }
    ...
    function ip(t, n, e, r) {
        ...
        return function(u) {
            ...
            function d(o, u) {
                var a = i(o, u);
                if (_ && y.push([o, u]), k)
                    g = o, m = u, x = a, k = !1, a && (S.lineStart(), S.point(o, u));
                else if (a && T)
                    S.point(o, u);
                else {
            ...
            function h() {
                ...
                if (v.pop(), p.push(v), v = null, a)
                    if (1 & i) {
                        ...
                        a > 1 && 2 & i && u.push(u.pop().concat(u.shift())), d.push(u.filter(Dp))
            }
            var p,
                d,
                v,
    ...
    function Yp(t, n, e, r) {
        var i;
        if (null == t)
            i = e * ob, r.point(-ib, i), r.point(0, i), r.point(ib, i), r.point(ib, 0), r.point(ib, -i), r.point(0, -i), r.point(-ib, -i), r.point(-ib, 0), r.point(-ib, i);
        ...
        function i(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    ...
                    if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (tp(n, p) || tp(d, p)) && (d[0] += eb, d[1] += eb, v = r(d[0], d[1]))), v !== i)
    ...
    P.prototype = q.prototype = {
        ...
        clear: function() {
            for (var t in this)
                t[0] === Rd && delete this[t]
        },
        keys: function() {
            var t = [];
            for (var n in this)
                n[0] === Rd && t.push(n.slice(1));
            return t
        },
        values: function() {
            var t = [];
            for (var n in this)
                n[0] === Rd && t.push(this[n]);
            return t
        },
        entries: function() {
            var t = [];
        ...
        each: function(t) {
            for (var n in this)
                n[0] === Rd && t(this[n], n.slice(1), this)
        }
    };
    var Ud = q.prototype;
                ...
                if (!(arguments.length < 2)) {
                    ...
                    for (; ++o < u;)
                        if (e = (t = i[o]).type)
                            ...
                            for (e in r)
                                r[e] = Sr(r[e], t.name, null);
                    return this
                }
                for (; ++o < u;)
                    if ((e = (t = i[o]).type) && (e = Nr(r[e], t.name)))
                        return e
            }
        },
        copy: function() {
    ...
    var Ag,
        Eg = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
        ...
        jm = function t(n) {
            function e(t, e, r, i, o) {
                if ((u = t._squarify) && u.ratio === n)
                    ...
                    t._squarify = u = sf(n, t, e, r, i, o), u.ratio = n
            }
            return e.ratio = function(n) {
                return t((n = +n) > 1 ? n : 1)
            }, e
    ...
    Pf.prototype.on = function() {
        ...
        insert: function(t, n) {
            ...
            if (t) {
                ...
                this._ ? (t = Hf(this._), n.P = null, n.N = t, t.P = t.L = n, e = t) : (n.P = n.N = null, this._ = n, e = null);
            for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;)
                r = e.U, e === r.L ? (i = r.R, i && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (Bf(this, e), t = e, e = t.U), e.C = !1, r.C = !0, jf(this, r))) : (i = r.L, i && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (jf(this, e), t = e, e = t.U), e.C = !1, r.C = !0, Bf(this, r))), e = t.U;
            this._.C = !1
        },
        remove: function(t) {
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(e, r) {
                for (var i, o = e.site, u = e.halfedges, a = -1, c = u.length, s = n[u[c - 1]], f = s.left === o ? s.right : s.left; ++a < c;)
                    i = f, s = n[u[a]], f = s.left === o ? s.right : s.left, r < i.index && r < f.index && pl(o, i, f) < 0 && t.push([o.data, i.data, f.data])
            }), t
        },
        links: function() {
